...
void titleScreenDisplayTitleText(WINDOW *wTitleText) {
...
void titleScreenDisplayAliensLocal(WINDOW *wAliensLocal) {
  int32_t iCounter;
  static int32_t frame = 0;
  int8_t buffer[12];
  int8_t ufo[4][6] = {"<o o>", "<oo >", "<o o>", "< oo>"};
...
void titleScreenDisplayWStartText(WINDOW *wStartText) {
...
void titleScreenDisplay(void)
{
  ...
  titleScreenDisplayTitleText(wTitleText);

  titleScreenDisplayAliensLocal(wAliensLocal);

  titleScreenDisplayWStartText(wStartText);
